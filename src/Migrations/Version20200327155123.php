 ...
 */
final class Version20200327155123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aide ADD demandeurs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', ADD message VARCHAR(255) NOT NULL, CHANGE objet_scenario_id objet_scenario_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE aide DROP demandeurs, DROP message, CHANGE objet_scenario_id objet_scenario_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE bombe CHANGE start start DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE fil CHANGE bombe_id bombe_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE game CHANGE scenario_id scenario_id INT DEFAULT NULL, CHANGE start start DATETIME DEFAULT \'NULL\'');
